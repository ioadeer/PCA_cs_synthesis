...
"""
 Extraer infromación de audio volcarlo a csv. Hacer análisis de acuerdo con tamaño de ventana de análisis dado ( frameSize) , y con hopSize determinado que idealmente sea 1/4 del tamaño de frameSize.
"""
