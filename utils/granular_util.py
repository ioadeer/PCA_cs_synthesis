...
''' este metodo devuelve la envolvente de una ventana de análisis normalizada en forma de numpy array de tamaño windowSize y de tipo windowType que puede ser 'hanning', 'hamming, 'blackman', 'gaussian', 'welch' y 'bartlett', TODO: agregar expodec y rexpodec 
'''
...
''' este método toma un numpy array que contiene valores de muestras de audio (audioData) y devuelve otro numpy array que también representa una lista de samples pero reordenados según el criterio rearrangeIndex
'''
def rearrenge(windowFrameSize, hopSize, audioData, rearrangeIndex, windowEnvType):
    #create arrays
